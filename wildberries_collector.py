...
class WildberriesDataCollector:
    ...
    def collect_daily_stats(self) -> Dict[str, pd.DataFrame]:
        ...
        logger.info(f'Начало сбора данных')
        return {
    ...
    def save_info(self):
        ...
        for key, value in info.items():
            ...
            logger.info(f'Таблица {key}, сохранена в {file_name}')
    ...
    def get_stocks_FBW_stats(self, nm_ids: list) -> pd.DataFrame:
        ...
        logger.info(f'Данные об остатках FBW загружены')
        return fbw_df
    ...
    def get_stocks_FBS_stats(self, nm_ids: list) -> pd.DataFrame:
        ...
        logger.info(f'Данные об остатках FBS загружены')
        return fbs_df
    ...
    def get_avg_pos(self, nm_ids: list, period: Literal['m', 't']) -> pd.DataFrame:
        ...
        avg_pos_list = []
        if period == 't':
            logger.info(f'Получение данных о средней позиции в поиске за день')
            ...
            logger.info(f'Получение данных о средней позиции в поиске за месяц')
    ...
    def get_characteristic(self):
        ...
        logger.info(f'Получение и преобразование данных об основных параметрах товаров')
        characteristic_df = convert_cards_list_to_df_for_funnel(self.cards_list)
        logger.info(f'Данные об основных параметрах товаров загружены')
    ...
    def waiting_of_analytics_report(self, id: str):
        ...
        while tries < WAITING_OF_ANALYTICS_REPORT_TRIES:
            ...
            if report_status == 'SUCCESS':
                logger.debug(f'Статус {report_status}')
                return True
    ...
    def get_report_response(self, start_date_time: str, end_date_time: str,
        ...
        logger.info(f'Получение отчета по {logger_report_type}')
    ...
    def get_final_funnel_data_frame(self) -> pd.DataFrame:
        ...
        logger.info(f'Начало сбора данных по воронке продаж')
